...
// // // // //         // Optionally clear the cart here after successful order creation
// // // // //       })
// // // // //       .catch((err) => {
...
//     const total = cart.reduce((total, item) => {
//       // Log the item details and quantity for debugging
//       console.log('Item details:', item);
//       console.log('Quantity:', item.quantity); // Log quantity directly to inspect it
